EmailTemplateController = RouteController.extend({
  ...
  waitOn: function () {
    return [Meteor.subscribe('smsTemplateMergeFields'), Meteor.subscribe('smsTemplates')];
  },
  data: function () {
...
Template.smsTemplate.rendered = function () {
