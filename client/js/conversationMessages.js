Template.conversationMessages.rendered = function() {
	var viewmodel = function () {
        ...
        var currenCconversation = Conversations.findOne({ _id: conversationSelected });
	...
	helper.applyBindings(viewmodel, 'conversationMessagesVM');
}
