...
_.extend(Enums, {
  ...
  lookUpAction: {
    ...
    ContactMethod_CellPhone:"ContactMethod_CellPhone",
...
_.extend(Enums, {
  ...
  lookUpTypes: {
    ...
    contactable: {
      status: {
        lookUpCode: Enums.lookUpCodes.contactable_status,
    ...
    contactMethod: {
      type: {
        ...
        lookUpActions: [Enums.lookUpAction.ContactMethod_Email, Enums.lookUpAction.ContactMethod_Phone]
      }
    }
  },
