...
_.extend(Enums, {
    ...
    hotListCategories: ['Employee', 'Customer', 'Contact'],
    stringConstants: {
    ...
    lookUpAction: {
        ...
        LeaderBoardType_Pipeline: "Pipeline",
    ...
    lookUpTypes: {
        leaderBoard: {
            type: {
                ...
                lookUpActions: [Enums.lookUpAction.LeaderBoardType_Activity,Enums.lookUpAction.LeaderBoardType_Pipeline,
                    Enums.lookUpAction.LeaderBoardType_Contacts]
            }
        },
        howHeardOf: {
            type: {
        ...
        customer: {
            status: {
                ...
                lookUpActions: [Enums.lookUpAction.Customer_Lost]
            },
            lostReason: {
                lookUpCode: Enums.lookUpCodes.customer_lostReason,
                displayName: 'Customer lost reasons',
                lookUpActions: []
            }
        },
        active: {
