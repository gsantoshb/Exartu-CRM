...
/*************************************************************************************************************
 *  Our's modification                                                                                       *
 *  When a binding error happends throw custom exeption that holds the Dom element where the error hapaned   *
 *  XR2 Team january 29th 2014                                                                               *
 *************************************************************************************************************/


(function () {
    CustomError = function (msg, node) {
        var simpleError = new Error(msg)
        simpleError.originElement = node;
        return simpleError;
    }
    var DEBUG = true;
        ...
        ! function (factory) {
            ...
            (function () {
                ...
                function simpleHtmlParse(html) {
                    ...
                    var wrap = tags.match(/^<(thead|tbody|tfoot)/) && [1, "<table>", "</table>"] || !tags.indexOf("<tr") && [2, "<table><tbody>", "</tbody></table>"] ||
                ...
                ko.selectExtensions = {
                    readValue: function (element) {
                        ...
                        case 'option':
                            ...
                            return ko.utils.ieVersion <= 7 ? (element.getAttributeNode('value').specified ? element.value : element.text) : element.value;
                        case 'select':
                ...
                ko.utils.extend(ko.bindingProvider.prototype, {
                    ...
                    'parseBindingsString': function (bindingsString, bindingContext, node) {
                        try {
                            ...
                            throw new CustomError("Unable to parse bindings.\nMessage: " + ex + ";\nBindings value: " + bindingsString, node);
                        }
                    }
                });
